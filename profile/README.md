<div align="center">
  <a href="https://wehuman.top">
    <img src="https://github.com/Wehuman01.png" width="104" alt="wehuman logo" />
  </a>
  <h1>wehuman</h1>
  <p><strong>The machine repeats. The person decides.</strong></p>
  <p>机器负责重复，人负责决定。</p>
  <p>
    <a href="https://wehuman.top">Website</a> &middot;
    <a href="https://wehuman01.github.io">Docs</a> &middot;
    <a href="mailto:peng@wehuman.top">Contact</a>
  </p>
</div>

> We build CLI-first, local-first, agent-operable tools that give people more room to choose.

## Built for agency

Most attention is lost between intending and starting. We work in that gap: quietly handling repetition while keeping boundaries clear and decisions human.

- **Agency first** - AI should enlarge a person's choices, not reshape life around another tool.
- **Local by default** - Your work, models, and credentials stay where they belong whenever possible.
- **Useful to agents** - Every interface should work well for people and the AI agents that help them.
...
After using a tool, does a person have more room to choose? If not, we improve it or retire it.

---

<div align="center">
  <sub>wehuman, est. 2026 &middot; A sister studio of <a href="https://www.webioinfo.top/">webioinfo</a></sub>
</div>
